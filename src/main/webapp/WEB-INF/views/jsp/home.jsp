        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <button type="button" class="btn btn-link"><a href="new">Add a new Record</a></button>   <br />
                    <button type="button" class="btn btn-link"><a href="list">List all records</a></button>   <br />
